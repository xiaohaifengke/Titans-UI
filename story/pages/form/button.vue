<template>
  <div class="button-demo-page">
    ...
    <div>
      ...
      <div>
        <TiButton type="primary" icon="search" shape="circle" size="large" mode="plain"></TiButton>
        <TiButton type="warning" icon="edit" shape="circle" size="small" mode="outline"></TiButton>
